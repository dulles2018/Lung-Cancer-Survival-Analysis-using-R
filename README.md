...
## Objective
Analyze factors associated with survival outcomes among lung cancer patients.

## Dataset
The lung dataset from the R survival package.
...
## Tools
R, RStudio, tidyverse, survival, survminer
